...
import com.bengisusahin.composeflow.ui.theme.ComposeFlowTheme
...
fun SecondScreen(viewModel: MyViewModel) {
    ...
    val stateFlowValue = viewModel.stateFlowValue.collectAsState()
    val sharedFlowValue = viewModel.sharedFlowValue.collectAsState(initial = "")
